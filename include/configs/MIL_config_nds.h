...
#ifndef _MIL_config_nds_h
#define _MIL_config_nds_h
...
#define MIL_TIMER_NDS	1

/* Enable various video drivers */
#define MIL_VIDEO_DRIVER_NDS	1
#define MIL_VIDEO_DRIVER_DUMMY	1

#endif /* _MIL_config_nds_h */
