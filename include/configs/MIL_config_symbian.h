...
#ifndef _MIL_CONFIG_SYMBIAN_H
#define _MIL_CONFIG_SYMBIAN_H
...
#define MIL_AUDIO_DRIVER_EPOCAUDIO	1
...
#define MIL_THREAD_SYMBIAN 1

#define MIL_VIDEO_DRIVER_EPOC    1

#define MIL_VIDEO_OPENGL 0
