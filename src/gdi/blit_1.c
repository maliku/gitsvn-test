...
static void Blit1to1(MIL_BlitInfo *info)
{
...
#define LO	1
#endif
static void Blit1to2(MIL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit1to3(MIL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit1to4(MIL_BlitInfo *info)
{
#ifndef USE_DUFFS_LOOP
	int c;
#endif
...
static void Blit1to1Key(MIL_BlitInfo *info)
{
...
static void Blit1to2Key(MIL_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static void Blit1to3Key(MIL_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static void Blit1to4Key(MIL_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static void Blit1toNAlpha(MIL_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static void Blit1toNAlphaKey(MIL_BlitInfo *info)
{
	int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static MIL_loblit one_blit[] = {
	NULL, Blit1to1, Blit1to2, Blit1to3, Blit1to4
};

static MIL_loblit one_blitkey[] = {
