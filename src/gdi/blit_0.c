...
static void BlitBto1(MIL_BlitInfo *info)
{
	int c;
	int width, height;
	Uint8 *src, *map, *dst;
...
static void BlitBto2(MIL_BlitInfo *info)
{
	int c;
	int width, height;
	Uint8 *src;
...
static void BlitBto3(MIL_BlitInfo *info)
{
	int c, o;
	int width, height;
	Uint8 *src, *map, *dst;
...
static void BlitBto4(MIL_BlitInfo *info)
{
	int width, height;
	Uint8 *src;
	Uint32 *map, *dst;
...
static void BlitBto4Key(MIL_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static void BlitBtoNAlphaKey(MIL_BlitInfo *info)
{
        int width = info->d_width;
	int height = info->d_height;
	Uint8 *src = info->s_pixels;
...
static MIL_loblit bitmap_blit[] = {
	NULL, BlitBto1, BlitBto2, BlitBto3, BlitBto4
};

static MIL_loblit colorkey_blit[] = {
    NULL, BlitBto1Key, BlitBto2Key, BlitBto3Key, BlitBto4Key
};

MIL_loblit MIL_CalculateBlit0(Surface *surface, int blit_index)
{
	int which;
