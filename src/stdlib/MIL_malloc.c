...
/* This file contains portable memory management functions for MIL */
...
#define memset	MIL_memset
#define memcpy	MIL_memcpy
#define malloc	MIL_malloc
#define calloc	MIL_calloc
#define realloc	MIL_realloc
#define free	MIL_free
