...
extern int MIL_SYS_TimerInit(void);

/* Quit the system dependent timer subsystem */
extern void MIL_SYS_TimerQuit(void);

/* Start a timer set up by MIL_SetTimer() */
extern int MIL_SYS_StartTimer(void);

/* Stop a previously started timer */
extern void MIL_SYS_StopTimer(void);
