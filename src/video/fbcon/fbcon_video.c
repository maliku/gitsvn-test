...
VIRTUAL_METHOD_REGBEGIN(FBconVideoDevice, VideoDevice)

    DESTRUCTOR_REGISTER(FBconVideoDevice)
    METHOD_REGISTER(FBconVideoDevice, videoInit)
    METHOD_REGISTER(FBconVideoDevice, listModes)
    METHOD_REGISTER(FBconVideoDevice, setVideoMode)
    METHOD_REGISTER(FBconVideoDevice, toggleFullScreen)
    METHOD_REGISTER(FBconVideoDevice, updateMouse)
    METHOD_REGISTER(FBconVideoDevice, createYUVOverlay)
    METHOD_REGISTER(FBconVideoDevice, setColors)
    METHOD_REGISTER(FBconVideoDevice, updateRects)
    METHOD_REGISTER(FBconVideoDevice, videoQuit)
    METHOD_REGISTER(FBconVideoDevice, allocHWSurface)
    METHOD_REGISTER(FBconVideoDevice, checkHWBlit)
    METHOD_REGISTER(FBconVideoDevice, fillHWRect)
    METHOD_REGISTER(FBconVideoDevice, setHWColorKey)
    METHOD_REGISTER(FBconVideoDevice, setHWAlpha)
    METHOD_REGISTER(FBconVideoDevice, lockHWSurface)
    METHOD_REGISTER(FBconVideoDevice, unlockHWSurface)
    METHOD_REGISTER(FBconVideoDevice, flipHWSurface)
    METHOD_REGISTER(FBconVideoDevice, freeHWSurface)
    METHOD_REGISTER(FBconVideoDevice, setGamma)
    METHOD_REGISTER(FBconVideoDevice, getGamma)
    METHOD_REGISTER(FBconVideoDevice, setGammaRamp)
    METHOD_REGISTER(FBconVideoDevice, getGammaRamp)
    METHOD_REGISTER(FBconVideoDevice, GL_LoadLibrary)
    METHOD_REGISTER(FBconVideoDevice, GL_GetProcAddress)
    METHOD_REGISTER(FBconVideoDevice, GL_GetAttribute)
    METHOD_REGISTER(FBconVideoDevice, GL_MakeCurrent)
    METHOD_REGISTER(FBconVideoDevice, GL_SwapBuffers)
